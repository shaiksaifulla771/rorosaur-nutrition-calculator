...
BEGIN
  ...
  IF v_email IN ('developer@lywo.in', 'sandeep@rorosaur.com', 'shaiksaifulla771@gmail.com') THEN
    v_role := 'admin';
...
BEGIN
  ...
  IF v_role = 'admin' AND v_email NOT IN ('developer@lywo.in', 'sandeep@rorosaur.com', 'shaiksaifulla771@gmail.com') THEN
    RETURN NULL;
  END IF;
